...
export const MOCK_APARTMENTS: Apartment[] = [
  {
    ...
    description: 'Căn hộ Studio cao cấp sở hữu ban công kính nhìn trực diện Landmark 81 sầm uất.',
  ...
  },
  {
    ...
    description: 'Nằm tại trung tâm khu phố cổ Hà Nội, căn hộ kết hợp tinh tế giữa nét đẹp Indochine truyền thống và nội thất thông minh tiện lợi.',
  ...
  },
  {
    ...
    description: 'Thức dậy cùng bình minh rực rỡ trên biển Mỹ Khê từ phòng ngủ master cửa kính sát trần.',
  ...
  },
  {
    ...
    description: 'Trải nghiệm phong cách sống "vô lo lo nghĩ" tại căn Penthouse nghỉ dưỡng sang trọng bậc nhất Phú Quốc.',
  ...
  },
  {
    ...
    description: 'Tận hưởng kỳ nghỉ trốn bụi mịn tại căn hộ gỗ phong cách Scandinavian cổ điển trên đỉnh Sapa.',
  ...
  },
  {
    ...
    description: 'Căn hộ dịch vụ cao cấp hướng đồi chè thơ mộng thuộc tổ hợp GrandStay Premier Thái Nguyên.',
