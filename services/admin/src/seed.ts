 ...
 * Run with: npx wrangler d1 execute DB --local --file=./src/seed.sql
 */
...
('prop-002', 'usr-002', 'Indochine Heritage 1BR Suite - Hoan Kiem', 'Căn hộ kết hợp tinh tế giữa nét đẹp Indochine truyền thống và nội thất thông minh.', '45 Hang Bai, Hoan Kiem', 'Hanoi', 'Vietnam', 2750000, 2, 1, 1, 'apartment', 'active', '2026-01-01T00:00:00Z', '2026-01-01T00:00:00Z'),
('prop-003', 'usr-002', 'My Khe Beachfront Panoramic 2BR', 'Thức dậy cùng bình minh rực rỡ trên biển Mỹ Khê từ phòng ngủ master.', '78 Vo Nguyen Giap, Son Tra', 'Da Nang', 'Vietnam', 3625000, 4, 2, 2, 'apartment', 'active', '2026-01-01T00:00:00Z', '2026-01-01T00:00:00Z'),
('prop-004', 'usr-005', 'Sunset Horizon Pool Villa', 'Trải nghiệm phong cách sống sang trọng tại căn Penthouse nghỉ dưỡng.', '12 Tran Hung Dao, Duong Dong', 'Phu Quoc', 'Vietnam', 7000000, 6, 3, 3, 'villa', 'active', '2026-01-01T00:00:00Z', '2026-01-01T00:00:00Z'),
('prop-005', 'usr-005', 'Misty Valley Cozy Chalet', 'Tận hưởng kỳ nghỉ trốn bụi mịn tại căn hộ gỗ phong cách Scandinavian.', '88 Fansipan, Sa Pa', 'Lao Cai', 'Vietnam', 2000000, 2, 1, 1, 'apartment', 'active', '2026-01-01T00:00:00Z', '2026-01-01T00:00:00Z'),
('prop-006', 'usr-002', 'Zen Garden Tea-view Suite', 'Căn hộ dịch vụ cao cấp hướng đồi chè thơ mộng.', '15 Dong Tam, Thai Nguyen', 'Thai Nguyen', 'Vietnam', 1875000, 2, 1, 1, 'apartment', 'maintenance', '2026-01-01T00:00:00Z', '2026-01-01T00:00:00Z');
