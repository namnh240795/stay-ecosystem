...
app.post("/api/seed", async (c) => {
  ...
  await db.prepare("CREATE TABLE IF NOT EXISTS reviews (id TEXT PRIMARY KEY, target_id TEXT, target_name TEXT, guest_name TEXT, rating INTEGER, comment TEXT, created_at TEXT)").run();
